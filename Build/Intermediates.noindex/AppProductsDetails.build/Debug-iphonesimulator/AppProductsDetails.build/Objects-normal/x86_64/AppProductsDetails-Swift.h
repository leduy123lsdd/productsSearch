...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppProductsDetails",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18AppProductsDetails11AppDelegate")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified nameOfProduct;
...
SWIFT_CLASS("_TtC18AppProductsDetails20scrollCollectionCell")
...
SWIFT_CLASS("_TtC18AppProductsDetails19scrollTableViewCell")
@interface scrollTableViewCell : UITableViewCell <UICollectionViewDataSource, UICollectionViewDelegate>
...
@interface scrollTableViewCell (SWIFT_EXTENSION(AppProductsDetails)) <UICollectionViewDelegateFlowLayout>
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout minimumLineSpacingForSectionAtIndex:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
@end
